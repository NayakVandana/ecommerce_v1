    ...
    return (
        <AppLayout>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-6">Shipping Information</h1>
                
                <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
                    <section>
                        <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-3 sm:mb-4">Shipping Options</h2>
                        <div className="space-y-3 sm:space-y-4">
                            <div className="border-l-4 border-indigo-500 pl-3 sm:pl-4">
                                <h3 className="font-semibold text-base sm:text-lg mb-1.5 sm:mb-2">Standard Shipping</h3>
                                <p className="text-gray-600 mb-2">5-7 business days</p>
                                <p className="text-gray-600">Free on orders over ₹50</p>
                            </div>
                            <div className="border-l-4 border-indigo-500 pl-3 sm:pl-4">
                                <h3 className="font-semibold text-base sm:text-lg mb-1.5 sm:mb-2">Express Shipping</h3>
                                <p className="text-gray-600 mb-2">2-3 business days</p>
                                <p className="text-gray-600">₹15.00</p>
                            </div>
                            <div className="border-l-4 border-indigo-500 pl-3 sm:pl-4">
                                <h3 className="font-semibold text-base sm:text-lg mb-1.5 sm:mb-2">Overnight Shipping</h3>
                    ...
                    <section>
                        <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-2 sm:mb-4">Processing Time</h2>
                    ...
                    <section>
                        <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-2 sm:mb-4">International Shipping</h2>
                        <p className="text-gray-600 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-2 sm:mb-4">Tracking Your Order</h2>
                        <p className="text-gray-600 leading-relaxed">
