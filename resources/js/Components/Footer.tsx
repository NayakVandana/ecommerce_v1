                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    Home
                                </Link>
                            </li>
                            <li>
                                <Link href="/products" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    All Products
                                </Link>
                            </li>
                            <li>
                                <Link href="/categories" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    Categories
                                </Link>
                            </li>
                            <li>
                                <Link href="/about" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    About Us
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    Contact Us
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/faq" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    FAQ
                                </Link>
                            </li>
                            <li>
                                <Link href="/shipping" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    Shipping Info
                                </Link>
                            </li>
                            <li>
                                <Link href="/privacy" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    Privacy Policy
                                </Link>
                            </li>
                            <li>
                                <Link href="/terms" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    Terms & Conditions
                                </Link>
                            </li>
                            <li>
                                <Link href="/cart" className="text-gray-400 hover:text-white transition-all inline-block hover:translate-x-1 transform duration-200 text-sm">
                                    Shopping Cart
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-3">
                                <a
                                    href="#"
                                    className="w-10 h-10 bg-gray-700 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition-all duration-200 transform hover:scale-110"
                                    aria-label="Facebook"
                                >
                                ...
                                <a
                                    href="#"
                                    className="w-10 h-10 bg-gray-700 hover:bg-sky-500 rounded-lg flex items-center justify-center transition-all duration-200 transform hover:scale-110"
                                    aria-label="Twitter"
                                >
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a
                                    href="#"
                                    className="w-10 h-10 bg-gray-700 hover:bg-pink-600 rounded-lg flex items-center justify-center transition-all duration-200 transform hover:scale-110"
                                ...
                                <a
                                    href="#"
                                    className="w-10 h-10 bg-gray-700 hover:bg-red-600 rounded-lg flex items-center justify-center transition-all duration-200 transform hover:scale-110"
                                    aria-label="YouTube"
                                >
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
