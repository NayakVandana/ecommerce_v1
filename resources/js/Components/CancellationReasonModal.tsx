...
export default function CancellationReasonModal({
    ...
    // Different reasons for customers vs admins
    const cancellationReasons = isCustomer ? [
        { value: 'changed_mind', label: 'Changed My Mind' },
        { value: 'found_better_price', label: 'Found Better Price Elsewhere' },
        { value: 'wrong_item', label: 'Wrong Item Ordered' },
        { value: 'delivery_address_incorrect', label: 'Delivery Address Incorrect' },
    ...
    const handleConfirm = () => {
        ...
        onConfirm({
            ...
            cancellation_notes: selectedReason === 'other' ? customReason.trim() : null,
        });
    };
                ...
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button
                            ...
                            className="inline-flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white shadow-sm bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
